...
const Navbar = () => {
  ...
  useEffect(() => {
    if (isMobile) return; // Skip all scroll effects on mobile
  ...
  return (
    <div
      ref={navContainerRef}
      className="inset-x-0 h-16 floating-nav transition-all duration-700 top-4 z-50 sm:inset-x-6 hidden md:block"
    >
