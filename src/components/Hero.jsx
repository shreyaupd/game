...
const Hero = () => {
  ...
  useEffect(() => {
    if (loadedvid === totalVideos) {
      setIsLoading(false);
      // Ensure background video plays when loaded
  ...
  return (
    <div className="relative h-dvh w-screen overflow-hidden">
      {/* Loading Screen */}
      {isloading && (
        <div className="absolute z-50 flex h-dvh w-screen items-center justify-center overflow-hidden bg-black">
      ...
      >
        <div>
          ...
          <video
            ...
            muted
            id="bg-video"
            className="absolute left-0 top-0 min-h-full min-w-full object-cover z-0"
            onLoadedData={handelloadedvideo}
          />
        </div>
